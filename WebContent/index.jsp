                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-4">
                        <div class="top-number"><p>
						 <i class="fa"></i>&nbsp&nbsp&nbsp&nbsp
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Creating Memories........ In a Flash</h1>
                                    <h2 class="animation animated-item-2">Capture the story remember the moment</h2>
